...
- **Mapa del Reino:** todas las aldeas (la tuya incluida) se muestran juntas como fichas sobre un mapa ilustrado (`MapaReino.jsx`), en posiciones fijas por cantidad de jugadores en vez de en una grilla de tarjetas. Las alianzas vigentes se dibujan como líneas punteadas entre las aldeas conectadas, visibles para todos (no solo las tuyas). Tocar cualquier ficha —la propia o una rival— la abre en una ficha de detalle debajo del mapa (`FichaAldea.jsx`) con la ilustración de la aldea, sus estadísticas y, si es un rival, los botones de proponer/romper alianza; si además hay una acción en curso (Asaltar, Defender, Enviar oro) que la acepte como objetivo, tocarla también la marca como tal.
